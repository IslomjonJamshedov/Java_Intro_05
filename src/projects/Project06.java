...
public class Project06 {
    public static void main(String[] args) {
        ...
        String[] strs = {"hi saeed", "i love java", "suayip", " "};
        countMultipleWords(strs);

        ArrayList<Integer> num1 = new ArrayList<>(Arrays.asList(1,2,3,4,-2,-4,6));
        removeNegatives(num1);
        validatePassword("islomgtI1@");
    ...
    public static void countMultipleWords(String [] arrayName){
        ...
        for (String words : arrayName){
            for (int i = 1; i < words.length() -1; i++) {
                if (words.charAt(i) == ' ' & Character.isLetter(words.charAt(i - 1))
