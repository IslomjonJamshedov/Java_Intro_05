...
public class MinAndMaxWithScanner {
    public static void main(String[] args) {
        ...
        System.out.println("Hey user give me a another number");
        ...
        System.out.println("\nMax of your numbers is  = " + Math.max(num1, num2) );
        System.out.println("Max of your numbers is  = " + Math.min(num1, num2) );
        ...
        System.out.println("Your second number is = " + number3);
